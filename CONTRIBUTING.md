...
# Contribute to Ory next-auth-example<!-- omit in toc -->
...
_Please note_: We take Ory next-auth-example's security and our users' trust
very seriously. If you believe you have found a security issue in Ory
next-auth-example, please disclose it by contacting us at security@ory.sh.
...
won't clash with Ory next-auth-example's direction. A great way to do this is
via [Ory next-auth-example Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/next-auth-example/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory next-auth-example?](#communication)
...
- I want to talk to other Ory next-auth-example users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  next-auth-example. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/next-auth-example)

- I would like updates about new versions of Ory next-auth-example.
...
[list of good first issues](https://github.com/ory/next-auth-example/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  next-auth-example. Github stars help the project gain visibility and stand
  out.
...
- **Help with open issues.** We have a lot of open issues for Ory
  next-auth-example and some of them may lack necessary information, some are
...
Check out
[Ory next-auth-example Discussions](https://github.com/orgs/ory/discussions).
...
next-auth-example, consider joining the mailing list. We will _only_ send you
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/next-auth-example/blob/master/.github/workflows/conventional_commits.yml)
...
next-auth-example's roadmap and architecture.
...
[Contributor License Agreement](https://cla-assistant.io/ory/next-auth-example).
...
git clone git@github.com:ory/ory/next-auth-example.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/next-auth-example.git
